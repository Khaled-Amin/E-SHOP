...
<div class="row backgroundW p-4 m-3">
    ...
    <form action="{{route('update.categories' , $getCategory_Id->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-controll" name="category_name" value="{{$getCategory_Id->name}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-controll" name="descrip" value="{{$getCategory_Id->description}}">
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">meta_title</label>
            <input type="text" class="form-controll" name="meta_title" value="{{$getCategory_Id->meta_title}}">
        </div>
        <div class="form-group">
        ...
        @if ($getCategory_Id->image)
            <img src="{{ asset('uploading/'.$getCategory_Id->image)}}" width="150px" height="100px" alt="Category Image">
        @endif<br><br>
        <div class="form-check form-check-inline">
            <label for="exampleFormControlTextarea1"><h6>إخفاء</h6></label>
            <input class="form-check-input" type="checkbox" name="status" {{$getCategory_Id->status == "1" ? 'checked' : ''}}>

            <label for="exampleFormControlTextarea1"><h6 style="margin-right:3px;">شائع</h6></label>
            <input class="form-check-input mb-5" type="checkbox" name="popular" {{$getCategory_Id->popular == "1" ? 'checked' : ''}}>
