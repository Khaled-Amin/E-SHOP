...
<div class="row backgroundW p-4 m-3">
    ...
    <form action="{{route('store.products')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-controll" name="product_name" placeholder="اسم المنتج">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-controll" name="small_descrip" placeholder="وصف">
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">وصف</label>
            {{-- <input type="text" class="form-controll" name="descrip" placeholder="وصف"> --}}
            <textarea name="descrip" rows="4" class="ckeditor form-controll"></textarea>
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">السعر الأصلي</label>
            <input type="text" class="form-controll" name="orig_price" placeholder="السعر الأصلي">
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">السعر المبيع</label>
            <input type="text" class="form-controll" name="sell_price" placeholder="السعر المبيع">
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">الكمية</label>
            <input type="number" class="form-controll" name="quantity" placeholder="الكمية">
        </div>
        <div class="form-group">
            <label for="exampleFormControlInput1">ضريبة</label>
            <input type="number" class="form-controll" name="taxx" placeholder="ضريبة">
        </div>
        <div class="form-group">
        ...
        <div class="form-check form-check-inline">
            <label for="exampleFormControlTextarea1"><h6>اخفاء</h6></label>
